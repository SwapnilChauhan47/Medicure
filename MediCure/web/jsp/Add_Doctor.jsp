...
<div class="sidebar">
  ...
  <a class="active" href="<%=application.getContextPath() %>/jsp/Add_Doctor.jsp">Add Doctor</a>
...
<%
    ...
    PreparedStatement pstmt=null,pstmt2=null,pstmt3=null,pstmt4=null;
        ...
        String sq="select * from patient where user_id="+uid;
...
<div class="container">
  <h2>Add Doctor</h2>
  <form action="<%= application.getContextPath() %>/jsp/Add_Doctor.jsp" method="post">
    <div class="form-group">
      <label for="name">Name</label>
      <input type="text" class="form-control" id="doctor_name" placeholder="Enter Doctor Name" name="name">
    </div>
    <div class="form-group">
      <label for="pwd">Id</label>
      <input type="text" class="form-control" id="doctor_id" placeholder="Enter Id Of Doctor" name="did">
    </div>
