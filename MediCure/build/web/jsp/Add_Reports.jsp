...
<div class="sidebar">
  ...
  <a class="active" href="<%=application.getContextPath() %>/jsp/Add_Reports.jsp">Add Reports</a>
...
<%
    ...
    String sql="insert into report(report_image,patient_id,doctor_id) values(?,?,?)";
...
<div class="container">
  <h2>Add Report</h2>
  <form action="<%= application.getContextPath() %>/jsp/Add_Reports.jsp">
